...
_EXCLUDE_KEYWORDS = [
    ...
    "اثاث", "تجهيزات محلات", "تجهيزات مطابخ", "تجهيزات المطاعم",
    "صيانه", "خدمات غاز", "تمديدات", "استشاري", "استشارات",
]
...
_FRESH_FOOD_KEYWORDS = [
    ...
    # التصنيع والملاحم — ينقلون بضاعة مبرَّدة بحكم نشاطهم
    "تصنيع اغذيه", "مصنع", "مصانع", "ملحمه", "ملاحم", "butcher",
]
...
#
# العتبة الأعلى (30) كانت تُسقط موردي أغذية حقيقيين إلى not_icp لأنهم
# بلا تقييم على خرائط جوجل — أي أنها تعاقب شحّ البيانات لا ضعف
# المطابقة. تصفية الملاءمة يقوم بها شرط hits == 0؛ ودور النتيجة هو
# الترتيب داخل الشريحة لا الإقصاء منها.
_MIN_ICP_SCORE = 20
